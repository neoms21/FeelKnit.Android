package com.qubittech.feeltastic.helpers;
...
public class NavigationDrawerHelper {
  ...
  public  void init(Activity theActivity, ListView.OnItemClickListener listener) {
    ...
    ArrayAdapter<String> navigationDrawerAdapter = new ArrayAdapter<String>(theActivity, R.layout.drawer, navigationDrawerOptions);
